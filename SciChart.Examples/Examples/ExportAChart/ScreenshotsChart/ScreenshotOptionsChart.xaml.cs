...
namespace SciChart.Examples.Examples.ExportAChart.ScreenshotsChart
{
    /// <summary>
    /// Interaction logic for ScreenshotOptionsChart.xaml
    /// </summary>
    public partial class ScreenshotOptionsChart : UserControl
    {
        public ScreenshotOptionsChart()
        {
            InitializeComponent();
