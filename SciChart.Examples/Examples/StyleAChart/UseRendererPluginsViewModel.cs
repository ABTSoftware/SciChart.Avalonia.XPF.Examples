...
// 
// UseRendererPluginsViewModel.cs is part of the SCICHART® Examples. Permission is
...
{
    public class UseRendererPluginsViewModel : BaseViewModel
    {
        ...
        public UseRendererPluginsViewModel()
        {
