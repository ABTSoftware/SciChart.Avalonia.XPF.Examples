...
namespace SciChart.Examples.Demo.Lib.Helpers.HtmlExport
{
    public static class HtmlExportHelper
    {
        ...
        public static void ExportExampleToHtml(Example example, bool isUniqueExport = true)
        {
            ...
            {
                string lines = sr.ReadToEnd();
                var exampleFolderPath = ExportPath;
                ProcessMainWindow("scichart-wpf-chart-example-" + example.Title.ToLower().Replace(" ", "-"), exampleFolderPath);
        ...
        private static void ProcessMainWindow(string title, string path)
        {
