...
using SciChart.Examples.Demo.Lib.CodeHighlighter.Compilation;
using SciChart.Examples.Demo.Lib.CodeHighlighter.Compilation.Languages;
...
namespace SciChart.Examples.Demo.Lib.CodeHighlighter
{
    ...
    {
        public static readonly LanguageRepository LanguageRepository;
        public static readonly Dictionary<string, ILanguage> LoadedLanguages;
        public static Dictionary<string, CompiledLanguage> CompiledLanguages;
