...
{
    public class ShowcaseCategoriesTrait : ViewModelTrait<MainWindowViewModel>
    {
        ...
        public ShowcaseCategoriesTrait(MainWindowViewModel target, IModule module, ISchedulerContext schedulerContext) : base(target)
        {
            _module = module;
