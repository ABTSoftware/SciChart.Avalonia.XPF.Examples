...
{
    public class AutoCompleteSearchTrait : ViewModelTrait<MainWindowViewModel>
    {
        ...
        public AutoCompleteSearchTrait(MainWindowViewModel target, ISchedulerContext schedulerContext, IExampleSearchProvider searchProvider, IModule module)
            : base(target)
        {
